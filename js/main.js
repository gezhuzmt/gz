...
const add_id = "mfmvswfuumvkvyee"; // app_id
const app_secret = "NVlYcEUwVXNySkQwVGQvbXRDeEZOQT09"; // app_secret
const key = "749ce4a56319425996f2688d28817fed" // key
function getWeather() {
...
$("#github").mouseover(function () {
    $("#link-text").html("去阁主空间看看");
}).mouseout(function () {
    $("#link-text").html("去阁主空间看看");
});
$("#qq").mouseover(function () {
    $("#link-text").html("精彩内容马上呈现");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#email").mouseover(function () {
    $("#link-text").html("来阁主副业让你不迷路");
}).mouseout(function () {
    $("#link-text").html("来阁主副业让你不迷路");
});
